...
Shader "Custom/GradientTransparent"
{
    Properties
    {
        _DirX("DirX", Float) = 0.0
        _DirY("DirY", Float) = 0.0
        _DirZ("DirZ", Float) = 0.0
    ...
    SubShader
    {
        ...
        float gradientAlpha(float l)
        {
            ...
            {
                float c = lerp(_Color, _SecondColor, (l / SEVENTH) - 1.0f).a;
                return c;
            }
            else if (l < SEVENTH * 3.0f)
            {
                float c = lerp(_SecondColor, _ThirdColor, (l / SEVENTH) - 2.0f).a;
                return c;
            }
            else if (l < SEVENTH * 4.0f)
            {
                float c = lerp(_ThirdColor, _FourthColor, (l / SEVENTH) - 3.0f).a;
                return c;
            }
            else if (l < SEVENTH * 5.0f)
            {
                float c = lerp(_FourthColor, _FifthColor, (l / SEVENTH) - 4.0f).a;
                return c;
            }
            else if (l < SEVENTH * 6.0f)
            {
                float c = lerp(_FifthColor, _SixthColor, (l / SEVENTH) - 5.0f).a;
                return c;
            }
            else
            {
                float c = _SixthColor.a;
                return c;
            }
        }
        ...
        {
            float dot = _DirX * IN.worldPos.x + _DirY * IN.worldPos.y + _DirZ * IN.worldPos.z;

            float mapped = (dot - (_MinRange + _Offset)) / (_MaxRange - _MinRange);
