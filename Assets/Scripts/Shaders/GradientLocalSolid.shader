Shader "Custom/GradientLocalSolid"
{
    ...
    SubShader
    {
        ...
        fixed4 gradient(float l)
        {
            ...
            else if (l < FOURTH * 2.0f)
            {
                fixed4 c = lerp(_Color, _SecondColor, (l / FOURTH) - 1.0f);
                return c;
            }
            else if (l < FOURTH * 3.0f)
            {
                fixed4 c = lerp(_SecondColor, _ThirdColor, (l / FOURTH) - 2.0f);
                return c;
            }
            else
            {
                fixed4 c = _ThirdColor;
                return c;
            }
        }
