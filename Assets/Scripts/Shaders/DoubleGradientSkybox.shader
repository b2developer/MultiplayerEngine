Shader "Custom/DoubleGradientSkybox"
{
	Properties
	{
		...
		_MiddleColor2("Middle Color 2", Color) = (1,1,1,1)
		_TopColor2("Top Color 2", Color) = (1,1,1,1)
		_Split12("Split 1 2", Range(0, 1)) = 0.0
		_Split22("Split 2 2", Range(0, 1)) = 0.0
		_Split32("Split 3 2", Range(0, 1)) = 0.0
	...
	LOD 100
		...
		#pragma shader_feature_local _SCREENSPACE_ON
			...
			uniform fixed4 _BottomColor2;
			uniform fixed4 _MiddleColor2;
			uniform fixed4 _TopColor2;
			float _Split12;
			float _Split22;
			float _Split32;
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				float lerpScalar = clamp(staticSwitch13, -1.0f, 1.0f);
				lerpScalar *= 0.5f;
				lerpScalar += 0.5f;

				fixed4 c = gradient(_BottomColor, _MiddleColor, _TopColor, _Split1, _Split2, _Split3, lerpScalar);
				fixed4 c2 = gradient(_BottomColor2, _MiddleColor2, _TopColor2, _Split12, _Split22, _Split32, lerpScalar);

				fixed4 lc = lerp(c, c2, _Lerp);
